...
function init() {
    ...
    smokeTexture = THREE.ImageUtils.loadTexture(`${window.location.origin}/img/smoke.png`);
    ...
    var canves_smoke = document.querySelector('#smoke');
    // document.body.appendChild( renderer.domElement );
    canves_smoke.appendChild( renderer.domElement );
